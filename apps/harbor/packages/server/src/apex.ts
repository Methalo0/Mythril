...
// The deployment face, served on the APEX domain (spaces.mythrillabs.com) —
...
export interface ApexDeps {
  ...
  hub: SpaceHub;
  /** e.g. spaces.mythrillabs.com — org domains are `<slug>.<apexDomain>`. */
  apexDomain: string;
...
- **Ask @mythril.** Mention @mythril in any message and *your* agent picks it up — summarize a thread, draft a doc, fold a decision into a file.
