...
import { mcpTools, NewPoll, type ActingMode, type ActivityItem, type ActivityKind, type SearchKind, relabelMentions, type Message } from '@mythril/spaces-protocol';
import { z } from 'zod';
...
// display label via x-agent-name). Mythril's own agent uses this exact
