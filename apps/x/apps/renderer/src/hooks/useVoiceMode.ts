...
let cachedAuth: { type: 'mythril'; url: string; token: string } | { type: 'local'; apiKey: string } | null = null;
...
export function useVoiceMode() {
    ...
    const refreshAuth = useCallback(async () => {
        ...
        if (
            ...
            cachedAuth = { type: 'mythril', url: mythrilConfig.websocketApiUrl, token: account.accessToken };
        } else {
