...
const msg = (offset: number): spaces.Message => ({
    ...
    postedAt: '2026-09-14T09:00:00Z', offset, replyCount: 0, mentions: [], mentionsHere: false, mentionsMythril: false, reactions: [],
})
...
describe('stream store — detached window', () => {
    ...
    it('live roots while detached are counted, not merged; rows in the window still update', async () => {
        ...
        act(() => live({ type: 'message_edited', edit: { messageId: 'm50', body: 'edited', at: '2026-09-14T10:00:00Z', mentions: [], mentionsHere: false, mentionsMythril: false } }))
