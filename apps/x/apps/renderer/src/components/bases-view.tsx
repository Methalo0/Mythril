      ...
      <Dialog open={saveDialogOpen} onOpenChange={setSaveDialogOpen}>
        <DialogContent className="sm:max-w-[360px]">
          ...
          <input
            ...
            className="w-full rounded-md border border-transparent bg-[var(--mythril-wash)] px-3 py-2 text-sm outline-none focus:border-border focus:ring-1 focus:ring-ring"
            autoFocus
          />
          <DialogFooter>
            <button
