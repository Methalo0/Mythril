...
/**
 * Settings → Permissions: every OS permission Mythril uses, grouped by the
...
const CHIP_STYLES: Record<string, string> = {
  granted: "bg-[var(--mythril-success)]/10 text-[var(--mythril-success)]",
    ...
    rows: [
      {
        ...
        hint: {
          ...
          denied: "macOS doesn't allow apps to prompt for this — enable Mythril in the pane, then relaunch the app.",
        },
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <p className="text-xs text-muted-foreground">
          What Mythril can access on this {status.platform === "darwin" ? "Mac" : "device"}, grouped by the feature
