  ...
  return (
    <aside
      ...
      className={cn(
        ...
        open ? 'border-r border-border bg-[var(--mythril-panel-soft)]' : 'border-r border-border bg-background',
      )}
    >
      {!open ? (
        ...
        <div className="flex h-full w-[240px] flex-col">
          <div className="mythril-header flex shrink-0 items-center gap-1 border-b border-border pl-3 pr-1.5">
