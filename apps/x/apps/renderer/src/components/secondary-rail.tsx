    ...
    return (
        <aside
            ...
            className={cn(
                ...
                open ? 'z-10 overflow-hidden bg-[var(--mythril-panel-soft)]' : 'overflow-visible bg-background',
                ...
                <>
                    ...
                    <div style={{ width: width + 50 }} className="pointer-events-none absolute inset-y-0 left-0 overflow-hidden">
                        <div
                            ...
                            style={{ width }}
                            className={cn(
                                'absolute bottom-1.5 left-0 top-1.5 overflow-hidden rounded-r-xl border border-border bg-[var(--mythril-panel-soft)] shadow-2xl transition-transform duration-200 ease-[cubic-bezier(0.2,0,0,1)]',
