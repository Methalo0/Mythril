      ...
      {pos !== null &&
        createPortal(
          <div
            ...
            className="z-[100] overflow-y-auto rounded-2xl border-none bg-popover p-2 shadow-[var(--mythril-shadow)]"
          >
            {deckFonts.length > 0 && (
              <>
...
export function EditorHeader({
  ...
  return (
    <header className="mythril-header flex shrink-0 items-center gap-2 border-b border-border px-3">
