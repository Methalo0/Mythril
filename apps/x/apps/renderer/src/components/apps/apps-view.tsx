...
export function AppsView({ initialAppFolder, initialVersion, onNewApp }: {
  ...
  const [apps, setApps] = useState<mythrilApp.AppSummary[]>([])
  ...
  return (
    <div className="ma-page">
      ...
      <div className="ma-inner">
        ...
        <p className="ma-sub">Apps that live inside Mythril, powered by your agents and integrations.</p>
