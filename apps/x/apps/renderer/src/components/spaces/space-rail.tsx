                                            ...
                                            <TooltipTrigger asChild>
                                                <ContextMenuTrigger asChild>
                                                    <button
                                                        ...
                                                        // a Mythril at work. The full title, replies, recency
                                                    ...
                                                    >
                                                        ...
                                                        {working && <Bot className="size-3 shrink-0 text-muted-foreground" aria-label="a Mythril is working here" />}
                        ...
                        {creatingBoard && (
                            <div className="flex items-center gap-1.5 px-1 pt-1">
                                ...
                                <input
                                    ...
                                    className="h-7 min-w-0 flex-1 rounded-md border border-transparent bg-[var(--mythril-wash)] px-2 text-xs text-foreground outline-none placeholder:text-muted-foreground focus:border-border"
                                    onKeyDown={(e) => {
