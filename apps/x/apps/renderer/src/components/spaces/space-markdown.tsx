        ...
        <>
            ...
            {confirming && (
                <Dialog open onOpenChange={(o) => { if (!o) setConfirming(false) }}>
                    ...
                    >
                        <DialogTitle>Leaving Mythril</DialogTitle>
 ...
 */
function MentionChip({ memberId, broadcast, fallback }: { memberId?: string; broadcast?: 'here' | 'mythril'; fallback: string }) {
    ...
    // @here and @mythril address the room and your agent — no profile to open.
...
function SpaceAnchor({ href, children }: ComponentProps<'a'>) {
    ...
    if (url === MYTHRIL_APP_URL) return <MentionChip broadcast="mythril" fallback="@mythril" />
