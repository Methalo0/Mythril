...
export function SelectionCopy() {
    ...
    return (
        <button
            ...
            className="z-50 -translate-x-1/2 inline-flex items-center gap-1.5 rounded-lg border-none bg-popover px-2 py-1 text-xs font-medium text-foreground shadow-[var(--mythril-shadow-soft)] hover:bg-accent"
        >
