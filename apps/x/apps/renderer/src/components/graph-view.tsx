...
{error ? (
      ...
      {legendItems.length > 0 ? (
        <div
          className="absolute right-3 top-3 z-20 rounded-md border-none bg-[var(--mythril-raised)] px-3 py-2 text-xs text-foreground shadow-[var(--mythril-shadow-soft)]"
      ...
      >
        <div className="relative flex items-center">
          ...
          <Input
            ...
            className="w-64 border-none bg-[var(--mythril-raised)] pl-9 pr-20 shadow-[var(--mythril-shadow-soft)]"
          />
