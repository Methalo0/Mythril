...
export function UpdateCard() {
  ...
  return (
    <div
      role="status"
      className="fixed bottom-4 left-4 z-50 w-[340px] rounded-2xl border-none bg-popover p-4 shadow-[var(--mythril-shadow)] animate-in fade-in slide-in-from-bottom-4 duration-300"
    >
      <div className="flex items-center gap-2">
        <span className="size-2 rounded-full bg-[var(--mythril-attention)] shrink-0" aria-hidden />
