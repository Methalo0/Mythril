  ...
  return (
    <span
      className={cn(
        ...
        working
          ? 'bg-[color-mix(in_oklab,var(--mythril-git)_12%,transparent)] text-[var(--mythril-git)]'
          : 'bg-[color-mix(in_oklab,var(--mythril-attention)_12%,transparent)] text-[var(--mythril-attention)]',
      )}
    >
        ...
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              ...
              copied && 'opacity-100 text-[var(--mythril-git)]',
            )}
          >
