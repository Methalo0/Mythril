  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <p className="text-base text-muted-foreground text-center leading-relaxed mb-6 max-w-md mx-auto">
        Use your existing Claude Code or Codex subscription inside Mythril to tackle coding
              ...
              {AGENTS.map((a) => {
                ...
                return (
                  <div key={a.key} className="rounded-xl border px-4 py-3 flex items-center gap-3">
                    ...
                    {ready && <CheckCircle2 className="size-4 text-[var(--mythril-success)] shrink-0" />}
                    <Switch
