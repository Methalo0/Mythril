  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isConnected
          ? "border-[var(--mythril-success)]/25 bg-[var(--mythril-success)]/5"
          : "hover:bg-muted/50"
      )}
    >
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <p className="text-base text-muted-foreground text-center leading-relaxed mb-8">
        Mythril gets smarter the more it knows about your work. Connect your accounts to get started. You can find more tools in Settings.
      </p>
        ...
        <div className="space-y-6">
          ...
          {(useComposioForGoogle || useComposioForGoogleCalendar || providers.includes('google') || providers.includes('microsoft')) && (
            <div className="space-y-3">
              ...
              {useComposioForGoogle ? (
                ...
                <ProviderCard
                  name="Google"
                  description="Mythril uses your email and calendar to provide personalized, context-aware assistance"
                  icon={<GmailIcon />}
                  iconBg="bg-red-500/10"
                  iconColor="text-red-500"
          ...
          <div className="space-y-3">
            ...
            <motion.div
              ...
              className="flex items-center justify-between gap-4 rounded-xl border border-[var(--mythril-success)]/25 bg-[var(--mythril-success)]/5 p-4"
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="size-10 rounded-lg flex items-center justify-center shrink-0 bg-[var(--mythril-success)]/10">
                  <span className="text-[var(--mythril-success)]"><FileText className="size-5" /></span>
                </div>
                <div className="min-w-0">
                  <div className="text-sm font-semibold">Mythril Meeting Notes</div>
