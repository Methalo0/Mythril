...
export function LlmSetupStep({ state }: LlmSetupStepProps) {
  ...
  const { defaultModel, isMythrilConnected } = useModels()
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <h2 className="text-3xl font-bold tracking-tight text-center mb-2">
        {isMythrilConnected ? "Add more providers" : "Connect a model provider"}
      </h2>
      <p className="text-base text-muted-foreground text-center mb-6">
        {isMythrilConnected
          ? "Mythril is ready to use. Optionally connect your own API keys or local models — their models appear alongside your Mythril models."
