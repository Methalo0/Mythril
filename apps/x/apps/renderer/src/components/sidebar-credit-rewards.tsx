...
const DISMISSED_KEY = "mythril.credit-rewards-card-dismissed"
                ...
                >
                  <div
                    className={cn(
                      ...
                      activity.claimed ? "bg-[var(--mythril-success)]/15" : "bg-muted",
                    )}
                  >
                    {activity.claimed ? (
                      <Check className="size-3.5 text-[var(--mythril-success)]" />
                    ) : (
            ...
            <div className="border-t p-2">
              <div className="flex items-center gap-2.5 px-2 py-1.5">
                <div
                  className={cn(
                    "flex size-6 shrink-0 items-center justify-center rounded-full",
                    inviteSlotsLeft === 0 ? "bg-[var(--mythril-success)]/15" : "bg-muted",
                  )}
                >
                  {inviteSlotsLeft === 0 ? (
                    <Check className="size-3.5 text-[var(--mythril-success)]" />
              ...
              {inviteSlotsLeft > 0 && (
                <div className="mx-2 mb-1 flex items-center gap-2">
                  ...
                  >
                    {copied ? <Check className="size-3 text-[var(--mythril-success)]" /> : <Copy className="size-3" />}
                    {copied ? "Copied" : "Copy"}
                  </button>
                </div>
              )}
