...
export function PptxEditor({ path, onSlideChange }: PptxEditorProps) {
  ...
  /**
   * A workspace:didChange / mythril:deck-touched signal for this path. Our
  ...
  useEffect(() => {
    ...
    window.addEventListener('mythril:deck-touched', onTouched)
    return () => window.removeEventListener('mythril:deck-touched', onTouched)
