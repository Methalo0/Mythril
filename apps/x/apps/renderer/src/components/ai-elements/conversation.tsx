    ...
    !isAtBottom && (
      <Button
        className={cn(
          ...
          // the shadow, 36px.
          "absolute bottom-6 left-[50%] z-10 h-9 w-9 translate-x-[-50%] rounded-full border-none bg-[var(--mythril-raised)] text-[var(--mythril-ink-secondary)] shadow-[var(--mythril-shadow-soft)] transition hover:bg-[var(--mythril-raised)] hover:text-foreground",
          className
        )}
