...
export const MessageContent = ({
  ...
  <div
    ...
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:max-w-[75%] group-[.is-user]:rounded-[22px] group-[.is-user]:bg-[var(--mythril-bubble)] group-[.is-user]:px-4 group-[.is-user]:py-2.5 group-[.is-user]:text-[var(--mythril-bubble-foreground)]",
