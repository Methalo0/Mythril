...
function NowBadge() {
  return (
    <span className="shrink-0 rounded bg-[var(--mythril-success)] px-1.5 py-px text-[10px] font-bold leading-[1.5] text-white">
      Now
    </span>
  )
}
      ...
      {open && menuPos
        ? createPortal(
            <div
              ...
              className="min-w-36 overflow-hidden rounded-2xl border-none bg-popover p-2 text-popover-foreground shadow-[var(--mythril-shadow)]"
            >
              <button
                type="button"
                onMouseDown={(e) => e.stopPropagation()}
