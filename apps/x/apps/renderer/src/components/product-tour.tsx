...
const TOUR_STEPS: TourStep[] = [
  {
    id: 'welcome',
    title: 'All aboard! ⚓',
    text: "I'm your captain for the next minute. The lights are down and the water's in, so let me row you across Mythril, one stop at a time. Use Next or your arrow keys.",
    voiceText: "I'm your captain for the next minute. The lights are down and the water's in, so let me row you across Mythril, one stop at a time.",
  },
  {
    id: 'spaces',
    targetId: 'nav-spaces',
  ...
  },
  {
    ...
    vignette: 'email',
    title: 'Email',
    text: 'Read and triage your inbox right here. Mythril sorts out what is important, labels the rest, and gets replies ready for you to send.',
  },
  {
    id: 'meetings',
  ...
  },
  {
    ...
    vignette: 'brain',
    title: 'Brain',
    text: 'Brain is your knowledge base. Notes, files, and everything Mythril learns for you, all connected and searchable.',
  },
  {
    id: 'home',
    targetId: 'nav-home',
    navigate: 'home',
    title: 'Todo',
    text: 'Todo is one rolling list of what needs doing. Mention @mythril on any line to hand it off, and my receipt lands right under the item when it is done.',
    voiceText: 'Todo is one rolling list of what needs doing. Mention at-mythril on any line to hand it off, and my receipt lands right under the item when it is done.',
  },
  {
    id: 'workspaces',
    ...
    hat: 'explorer',
    title: 'Projects',
    text: 'Projects keep local files and related chats together. Pick a chat in the rail to work with Mythril, or open a file alongside it.',
  },
  {
    id: 'agents',
    targetId: 'nav-agents',
  ...
  },
  {
    ...
    navigate: 'apps',
    title: 'Apps',
    text: 'Apps are mini-apps you build right here in Mythril. They get the same tools and integrations I do, and you can share them with other people. Just ask for one in chat.',
  },
  {
    id: 'chats',
    targetId: 'nav-chats',
...
export function ProductTour({
  ...
  useEffect(() => {
    const shell = document.querySelector<HTMLElement>('.mythril-shell')
      ...
      >
        ...
        {arrived && (
          <div
            key={step.id}
            className={cn(
              'pointer-events-auto absolute top-0 z-10 rounded-2xl border-none bg-popover p-4 text-popover-foreground shadow-[var(--mythril-shadow)]',
