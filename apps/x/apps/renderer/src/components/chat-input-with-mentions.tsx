...
// Stored in the workspace (~/.mythril/config) so it travels with the workspace and
...
const RECENT_WORK_DIRS_CHANGED_EVENT = 'mythril-chat-recent-work-dirs-changed'
...
function ChatInputInner({
  ...
  const { isMythrilConnected, defaultModel, defaultEffort, refresh: refreshModels } = useModels()
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // the shadow (see .mythril-chat-input in App.css).
        'mythril-chat-input rounded-[24px] border bg-background',
