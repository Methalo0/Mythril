  ...
  return (
    ...
    >
      ...
      <div className="relative flex min-w-0 flex-1 flex-wrap items-center gap-1" ref={fieldRef}>
        ...
        {showSuggestions && (
          <ul
            className="absolute left-0 top-[calc(100%+6px)] z-30 m-0 max-h-[296px] w-max min-w-[280px] max-w-[min(440px,100%)] list-none overflow-y-auto overscroll-contain rounded-2xl border-none bg-popover p-2 text-popover-foreground shadow-[var(--mythril-shadow)]"
            role="listbox"
            ref={listRef}
          >
