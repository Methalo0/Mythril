...
function cs(over: Partial<spaces.ChangeSet> & { id: string }): spaces.ChangeSet {
    return {
        ...
        baseVersion: 31,
        resultVersion: 32,
        attribution: { memberId: 'arjun', actingMode: 'agent', agentName: 'Mythril' },
...
describe('stream helpers', () => {
    it('treats same-author messages within five minutes as continuations', () => {
        ...
        const viaAgent = msg({ id: 'd', postedAt: '2026-08-19T10:04:30Z', author: { memberId: 'gagan', actingMode: 'agent', agentName: 'Mythril' } })
