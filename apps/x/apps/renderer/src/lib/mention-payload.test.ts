...
const mentions: Mention[] = [
  ...
  { kind: 'space', id: 'm2', orgId: 'org-1', orgName: 'mythril', spaceId: '01SPACE', displayName: 'Design' },
  {
    kind: 'board',
    id: 'm3',
    orgId: 'org-1',
  ...
  { kind: 'member', id: 'm4', orgId: 'org-1', orgName: 'mythril', memberId: '01HARSH', displayName: 'Harsh Kumar' },
]
...
describe('splitMentions', () => {
  it('keeps files as attachments and turns spaces, boards and people into context refs', () => {
    ...
    expect(spaceMentions).toEqual([
      { kind: 'space', orgId: 'org-1', orgName: 'mythril', spaceId: '01SPACE', name: 'Design' },
      {
        kind: 'board',
        orgId: 'org-1',
        orgName: 'mythril',
      ...
      { kind: 'member', orgId: 'org-1', orgName: 'mythril', memberId: '01HARSH', displayName: 'Harsh Kumar' },
    ])
  })
