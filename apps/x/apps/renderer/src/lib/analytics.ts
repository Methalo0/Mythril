...
export function spacesMessagePosted(props: { kind: 'general' | 'topic'; mentionsMythril: boolean }) {
  posthog.capture('spaces_message_posted', { kind: props.kind, mentions_mythril: props.mentionsMythril })
}
