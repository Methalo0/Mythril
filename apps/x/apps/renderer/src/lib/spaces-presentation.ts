...
/** Org monogram: "mythril.team" → "RT", "MetHalo11885260 (dev)" → "RL". */
...
export function rewriteMentionLinks(body: string): string {
    return mapMentionTokens(body, (ref) => {
        ...
        return `[@${ref.kind}](${ref.kind === 'here' ? HERE_APP_URL : MYTHRIL_APP_URL})`
    })
}

export const HERE_APP_URL = 'app://space-mention/here'
export const MYTHRIL_APP_URL = 'app://space-mention/mythril'
