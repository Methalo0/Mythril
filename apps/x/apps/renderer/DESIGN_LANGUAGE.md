# Mythril Design Language

Mythril's visual language, specified so it can be applied directly to the existing token
...
- **The agent in the room**: @mythril keeps the assistant identity — round
...
## 8. Applying to Mythril (`src/App.css`)
...
:root {
  ...
  --card-surface: #ffffff;
  --mythril-panel: #f4f4f4;
  --mythril-raised: #ffffff;
  --mythril-wash: #ebebeb;                /* inset fields */
  --mythril-hairline: rgba(0, 0, 0, 0.12);
  --mythril-command: #0d0d0d;
  --mythril-attention: #e5484d;
  --mythril-shadow: 0 0 0 1px rgba(0,0,0,.06), 0 12px 32px rgba(0,0,0,.10), 0 4px 12px rgba(0,0,0,.05);
  --mythril-shadow-soft: 0 0 0 1px rgba(0,0,0,.06), 0 8px 24px rgba(0,0,0,.06);

  /* Language extensions */
  --mythril-link: #3478f6;
  --mythril-success: #1ea446;
  --mythril-git: #8b5cf6;
  --mythril-bubble: #0d0d0d;
  --mythril-bubble-foreground: #ffffff;
  --mythril-ink-secondary: #5d5d5d;
}
...
.dark {
  ...
  --card-surface: #2a2a2a;
  --mythril-panel: #171717;
  --mythril-raised: #2a2a2a;
  --mythril-wash: #303030;
  --mythril-hairline: rgba(255, 255, 255, 0.14);
  --mythril-command: #ececec;
  --mythril-attention: #f2555a;
  --mythril-shadow: 0 0 0 1px rgba(255,255,255,.08), 0 12px 32px rgba(0,0,0,.45), 0 4px 12px rgba(0,0,0,.3);
  --mythril-shadow-soft: 0 0 0 1px rgba(255,255,255,.08), 0 8px 24px rgba(0,0,0,.35);

  --mythril-link: #5b94ff;
  --mythril-success: #3dcb70;
  --mythril-git: #a78bfa;
  --mythril-bubble: #303030;
  --mythril-bubble-foreground: #ececec;
  --mythril-ink-secondary: #a6a6a6;
}
```
...
6. Chat: user bubbles `--mythril-bubble` at radius 22; assistant messages full-width prose at 16/26; inline code chips on `--muted` radius 6.
7. Scrollbars: overlay-style thin thumbs on transparent tracks (values above).
8. Shadows only on: popovers/menus (`--mythril-shadow`), composer (`--mythril-shadow-soft`), floating circle buttons. Cards get hairline borders, no shadow.
