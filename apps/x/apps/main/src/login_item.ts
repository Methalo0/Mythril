 ...
 * (...\Mythril-win32-x64\app-x.y.z\mythril.exe), and Electron defaults the
...
// The stub shares our basename (mythril.exe) and lives one level above the
 ...
 * app-x.y.z\mythril.exe was current at registration time — unknowable now,
