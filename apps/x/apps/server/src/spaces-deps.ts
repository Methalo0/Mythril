...
type SpacesRpcChannel =
  ...
  | 'spaces:accountState' | 'spaces:signInMythril' | 'spaces:addOrgByAddress'
  ...
  | 'spaces:invokeMythril' | 'spaces:topicSession' | 'spaces:responseSession' | 'spaces:stopMythril'
...
export const spacesRpcHandlers: SpacesHandlers = {
  ...
  'spaces:invokeMythril': async (args) => invokeTopicAgent(args),
  ...
  'spaces:stopMythril': async (args) => stopTopicAgent(args),
