...
import type { Member, Space } from '@mythril/spaces-protocol';
      ...
      <View style={{ flex: 1, justifyContent: 'center', gap: 28 }}>
        <View style={{ alignItems: 'center', gap: 10 }}>
          ...
          <View style={{ alignItems: 'center', gap: 4 }}>
            ...
            <Text style={{ fontSize: 14, color: colors.tertiaryLabel }}>by Mythril</Text>
          </View>
        </View>
        ...
        <View style={{ gap: 20, marginTop: 8 }}>
          ...
          <FeatureRow
            ...
            detail="Mention @mythril and your agent picks it up — as you, for you."
          />
        </View>
      </View>
      ...
      <View style={{ paddingBottom: 40, gap: 14 }}>
        ...
        >
          {busy
            ...
            : <Text style={{ fontSize: 16, fontWeight: '600', color: colors.background }}>Sign in with Mythril</Text>}
        </Pressable>
        <Pressable onPress={() => router.push('/pairing')} style={{ alignItems: 'center', padding: 4 }}>
          <Text style={{ fontSize: 14, color: colors.secondaryLabel }}>
            Use Mythril on your Mac? <Text style={{ fontWeight: '600', color: colors.label }}>Connect your Mac</Text>
          </Text>
        </Pressable>
