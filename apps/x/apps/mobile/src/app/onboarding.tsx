...
export const ONBOARDED_KEY = 'mythril.onboarded.v1';
...
const SLIDES = [
  ...
  },
  {
    ...
    detail: 'Mention @mythril in any message and your agent picks it up — summarize a thread, draft a doc, fold in a decision.',
  },
  {
    icon: 'sf:laptopcomputer.and.iphone',
    title: 'Bring your Mac',
    detail: 'Use the Mythril Mac app? Connect it any time from the menu to continue your chats and read your Brain from your phone.',
  },
] as const;
