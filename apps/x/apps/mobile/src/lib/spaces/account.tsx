...
export const APEX_URL = process.env.EXPO_PUBLIC_SPACES_APEX ?? 'https://spaces.x.mythrillabs.com';

const ACCOUNT_KEY = 'mythril.spaces.account.v1';
/** Last-seen org list — painted instantly on launch, refreshed in the background. */
const ORGS_CACHE_KEY = 'mythril.spaces.orgs.v1';

export interface SpacesOrg {
  id: string;
  name: string;
  /** host, e.g. mythril.spaces.x.mythrillabs.com */
  address: string;
  memberId: string;
  displayName: string;
  role: string;
