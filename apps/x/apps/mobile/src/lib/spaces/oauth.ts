...
// deep-link redirect (mythril://oauth-callback — verified accepted by
...
export const REDIRECT_URI = 'mythril://oauth-callback';
const SCOPES = 'openid email profile';
/** DCR registrations cached per issuer — registering once per install is plenty. */
const CLIENT_KEY = 'mythril.spaces.oauth.client.v1';
