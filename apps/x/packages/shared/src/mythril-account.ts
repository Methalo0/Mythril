...
export const MythrilApiConfig = z.object({
  appUrl: z.string(),
  websocketApiUrl: z.string(),
  supabaseUrl: z.string(),
  // Mythril Spaces managed apex (org creation) — null/absent until a spaces
  ...
  // intended model differs; for mythril they reproduce the pre-v2 curated
...
export type ModelRecommendations = NonNullable<z.infer<typeof MythrilApiConfig>['modelRecommendations']>;
