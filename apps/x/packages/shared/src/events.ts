...
// ---------------------------------------------------------------------------
// Mythril events — the shared queue feeding the live-note + bg-task consumers.
//
...
export const MythrilEventSchema = z.object({
...
export type MythrilEvent = z.infer<typeof MythrilEventSchema>;
