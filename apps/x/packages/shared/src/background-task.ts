...
export type BackgroundTask = {
    ...
    // Folder slug of the Mythril App that installed this task (spec §8.2).
...
export const BackgroundTaskSchema = z.object({
    ...
    effort: z.enum(['low', 'medium', 'high', 'xhigh', 'ultrahigh']).optional().describe('ADVANCED — leave unset. Reasoning effort paired with the per-task model override; unset means Auto (provider default). Only meaningful alongside `model`.'),
