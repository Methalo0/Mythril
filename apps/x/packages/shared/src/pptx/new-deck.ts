...
function corePropsXml(title: string, createdAt: string): string {
  ...
  return (
    ...
    '<cp:lastModifiedBy>Mythril</cp:lastModifiedBy>' +
...
function appPropsXml(): string {
  return (
    ...
    '<Application>Mythril</Application>' +
    '<Slides>1</Slides>' +
 ...
 * Mythril-generated deck — including anything this function already
