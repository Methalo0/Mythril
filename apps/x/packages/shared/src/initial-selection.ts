 ...
 *   1. If Mythril's recommended model for this flavor appears in the
 ...
 * (from /v1/config via mythril:getConfig, keyed by provider FLAVOR in each
...
// Mythril default: kimi-k3 is the preferred chat model on NVIDIA NIM.
const MYTHRIL_PREFERRED: Record<string, string> = {
...
export function selectInitialModel(
    ...
    const preferred = MYTHRIL_PREFERRED[flavor];
