...
// Mythril's agents need (the copilot's system prompt + tool schemas alone are
...
export type ReasoningEffort = "low" | "medium" | "high" | "xhigh" | "ultrahigh";
 ...
 * - gpt-oss accepts effort levels directly ("low" | "medium" | "high" | "xhigh" | "ultrahigh").
