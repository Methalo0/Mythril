...
import type { MythrilEvent, ConsumerResult } from '@x/shared/dist/events.js';
...
function moveEventToDone(filename: string, enriched: MythrilEvent): void {
 ...
 */
function migrateLegacyTarget(event: MythrilEvent): MythrilEvent {
