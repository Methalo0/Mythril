...
const GH_HEADERS = { 'Accept': 'application/json', 'User-Agent': 'mythril-apps' };
...
export async function pollDeviceFlow(): Promise<PollResult> {
    ...
    const userRes = await fetch('https://api.github.com/user', {
        headers: { 'Authorization': `Bearer ${accessToken}`, 'Accept': 'application/vnd.github+json', 'User-Agent': 'mythril-apps' },
    });
