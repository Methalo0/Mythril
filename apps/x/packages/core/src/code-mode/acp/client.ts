...
// via MYTHRIL_ACP_STARTUP_TIMEOUT_MS (CI smoke test; escape hatch for MCP-heavy setups).
const STARTUP_TIMEOUT_MS = Number(process.env.MYTHRIL_ACP_STARTUP_TIMEOUT_MS) > 0
    ? Number(process.env.MYTHRIL_ACP_STARTUP_TIMEOUT_MS)
    : 60_000;
