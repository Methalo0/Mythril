...
//    (@mythril/spaces-protocol `mcpTools`) becomes a builtin of the same name,
...
import { z } from "zod";
import { blobLinkUrl, mcpTools, readOnlyMcpToolNames } from "@mythril/spaces-protocol";
...
export const ORG_ARG = z
    ...
    .optional()
    .describe(
        "Which org: its name (e.g. \"mythril\"), id, or spaces-<org> server name. " +
