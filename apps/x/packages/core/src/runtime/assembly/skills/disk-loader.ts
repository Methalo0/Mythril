...
// Locations scanned for <skill-name>/SKILL.md subfolders. The mythril root is
// derived from WorkDir so it honors the MYTHRIL_WORKDIR override (defaults to
// ~/.mythril/skills); it is scanned first so it wins on id collisions across
