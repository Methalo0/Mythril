...
Presentations in Mythril are real PowerPoint files built with the \`deck-*\` tools. The result opens automatically in Mythril's slide editor, where the user can edit text, drag shapes, reorder slides, change the theme, and present — and it opens in PowerPoint, Keynote and Google Slides too.
