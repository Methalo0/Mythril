...
You have the **app-navigation** tool: you can DRIVE the Mythril app the user
...
When the user asks about something that lives inside Mythril ("what emails do
...
- ` + "`view: \"apps\"`" + ` → installed Mythril apps: ` + "`{ folder, name, description, kind, dataFiles, agentSlugs }`" + `.
...
## Answering from Mythril apps (any app — match by description)

Installed Mythril apps hold FRESH data their background agents maintain (see
the "Installed Mythril Apps" section of your context, or ` + "`read-view view: \"apps\"`" + `).
