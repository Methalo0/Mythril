...
const definitions: SkillDefinition[] = [
  ...
  },
  {
    ...
    summary: "Navigate the app UI - open notes, switch views, answer from an installed Mythril app's data and surface it, filter/search the knowledge base, manage saved views, and point at the user's shared screen during calls.",
  ...
  },
  {
    id: "apps",
    title: "Mythril Apps",
    summary: "Build a Mythril App the user opens inside Mythril — a static web app on its own origin, powered by their integrations and an optional background agent. Use when the user asks to make/build/create an app or dashboard; for ambiguous 'show me X' requests, confirm whether they want an app first.",
    content: appsSkill,
    tools: [
      "app-navigation",
      "app-set-data",
  ...
  },
  {
    id: "notify-user",
    title: "Notify User",
    summary: "Send native desktop notifications with optional clickable links — including mythril:// deep links that open a specific note, chat, or view inside the app.",
...
// Bundled skills are static. Disk skills (~/.mythril/skills, ~/.agents/skills)
