...
process.env.MYTHRIL_WORKDIR = fs.mkdtempSync(path.join(os.tmpdir(), "x-classification-stamp-test-"));
...
const SYNC_DIR = path.join(process.env.MYTHRIL_WORKDIR, "gmail_sync");
