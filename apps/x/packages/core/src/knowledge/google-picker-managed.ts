...
// Managed (mythril-mode) OAuth-redirect Picker. Unlike BYOK, the OAuth runs on
// the Mythril backend with the COMPANY Google client — the desktop never holds
...
//
// Backend contract (Mythril webapp/api — NOT this repo). Mirrors the existing
...
//        mythril://oauth/google/picker/done?session=<state>
...
//        Authenticated with the user's Mythril bearer. Returns
...
/**
 * Deep-link handler for mythril://oauth/google/picker/done?session=<state>.
