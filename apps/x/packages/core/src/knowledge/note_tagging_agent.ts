...
3. Classify the note using the Mythril Tag System (Note Tags section) appended below.
...
- Only use tag values from the Mythril Tag System — do not invent new tags.
...
9. **Only use tags from the Mythril Tag System** — do not invent new tags.
