...
const NOTICE_MARKER = '<!-- mythril-today-md-deprecated -->';
const DEPRECATION_NOTICE = `${NOTICE_MARKER}
> Mythril's Today.md live dashboard is paused for now while we work on a better experience. You can keep using this note as a regular markdown file. If you want Mythril to keep updating it automatically, re-enable the live note settings; automatic updates may use credits.
