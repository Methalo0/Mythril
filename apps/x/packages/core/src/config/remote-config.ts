 ...
 * we use this to discover the webapp host (where the mythril-mode OAuth
...
interface RemoteConfig {
    ...
    /** Mythril Spaces managed apex (org creation) — null until a fleet exists for this environment. */
