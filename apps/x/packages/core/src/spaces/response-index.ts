...
// id: sessions are local to the machine whose Mythril ran, so nobody else
...
export type ResponseSessionResolution =
  ...
  | { status: 'gone' }
  /** Nothing recorded: a post from before this index existed, or not this member's Mythril. */
  | { status: 'unknown' };
