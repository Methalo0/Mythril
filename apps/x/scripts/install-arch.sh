#!/usr/bin/env bash
# Build the Mythril desktop app as an Arch package and install it with pacman.
#
...
echo "    (Spaces needs MYTHRIL_SPACES=1 in the environment, e.g. ~/.config/environment.d/mythril.conf)"
